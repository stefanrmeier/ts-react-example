...
class LoginFormView extends React.Component<Props, any> {
        ...
        <div className="row">
          <div className="col-xs-12">
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <button type="submit" disabled={pristine || submitting} className="btn btn-sm btn-primary" style={{ width: '100%', textAlign: 'left' }}>Login</button>
              </div>
            </form>
          </div>
        </div>
